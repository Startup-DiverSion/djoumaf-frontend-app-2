<template>
  <section class="flex flex-col lg:p-4 lg:w-11/12 w-full m-auto" v-if="toAccess == 2">
    ...
    <div class="flex flex-col gap-4 lg:px-8 px-4">
      <div v-for="(exp, index) in CV_Data" :key="index">
        <div class="flex flex-col gap-4 pt-4">
          <div class="text-sm font-semibold">Experience #{{ index + 1 }}</div>
          ...
          <div class="flex flex-col">
            ...
            <OnlyInput
              ...
              @update:modelValue="CV_Data[index].type_exp = $event.target.value"
            />
          </div>
