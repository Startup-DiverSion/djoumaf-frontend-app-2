<template>
  <section class="flex flex-col lg:p-4 lg:w-11/12 w-full m-auto" v-if="toAccess == 1">
    ...
    <div class="flex flex-col gap-4 lg:px-8 px-4">
      <div v-for="(form, index) in CV_Data">
        ...
        <BtnRemove label="suprimer cette formation" :index="index" @click="removeData(index)" />
      </div>
    </div>
