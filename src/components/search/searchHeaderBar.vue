<template>
  <div class="fixed left-0 w-[100%] lg:w-[30%] mx-0 lg:m-[72px] z-20" v-if="state.active_search">
    <div
      class=" bg-white rounded-md h-10 flex items-center px-2 gap-4 mx-2 cursor-pointer"
    >
    ...
    <div
      class="bg-white w-full absolute top-12 lg:hidden"
      v-if="$route.name === 'Search'"
    >
      <div
        class="flex gap-4 whitespace-nowrap overflow-auto scrollbar-hide w-11/12 m-auto"
      >
