<template>
  <ModalLayout
    classe-name="modal-profile hidden "
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataProfile.first_name = $event.target.value
                "
                :error-input="isError"
              />
            </div>
            ...
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataProfile.last_name = $event.target.value
                "
                :error-input="isError"
              />
            </div>
            ...
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataProfile.contact = $event.target.value
                "
                :error-input="isError"
              />
            </div>
            ...
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataProfile.adresse = $event.target.value
                "
                :error-input="isError"
              />
            </div>
            ...
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataProfile.site_web = $event.target.value
                "
                :error-input="isError"
              />
            </div>
  ...
  setup(props, {}) {
    ...
    const editProfile = async () => {
      ...
      try {
        ...
        const { error, context } = await new ProfileValidate().EditProfile(
          inputDataProfile
        );
        if (error) {
          state.loading = false;
        ...
        if (data) {
          ...
          new NotifUtils().success(
            "Modifier",
            "Resumer du profile modifer avec succès",
            5000
          );
