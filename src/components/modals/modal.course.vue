          ...
          <div class="flex flex-col gap-4">
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataCourse.etablishment = $event.target.value
                "
                :error-input="isError"
              />
            </div>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-4 w-full">
              <div class="flex flex-col w-full">
                ...
                <formSelect
                  ...
                  @update:modelValue="
                    inputDataCourse.diploma = $event.target.value
                  "
                  name="diploma"
              ...
              <div class="flex flex-col">
                ...
                <OnlyForm
                  ...
                  @update:modelValue="
                    inputDataCourse.domain = $event.target.value
                  "
                  :error-input="isError"
                />
              </div>
            ...
            <div class="flex flex-col">
              ...
              <OnlyForm
                ...
                @update:modelValue="
                  inputDataCourse.work_place = $event.target.value
                "
                :error-input="isError"
              />
            </div>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-4 w-full">
              <div class="flex flex-col">
                ...
                <formDate
                  ...
                  @update:modelValue="
                    inputDataCourse.date_start = $event.target.value
                  "
                  :error-input="isError"
                />
              </div>
              ...
              <div class="flex flex-col">
                ...
                <formDate
                  ...
                  @update:modelValue="
                    inputDataCourse.date_finish = $event.target.value
                  "
                  :error-input="isError"
                  :disabled="true"
                  :to-day="true"
...
export default defineComponent({
  ...
  setup(props, {}) {
    ...
    const addNewCourse = async () => {
      ...
      try {
        const { error, context } = await new ProfileValidate().Course(
          inputDataCourse
        );
        if (error) {
          state.loading = false;
        ...
        if (data) {
          ...
          data.course.date_start_y = moment(data.course.date_start).format(
            " Y"
          );
    ...
    const updateCourse = async () => {
      ...
      if (data) {
        ...
        new NotifUtils().success(
          "Modifier",
          "Formation modifier avec succès",
          5000
        );
      }
    ...
    const deleteCourse = async () => {
      try {
        ...
        if (data) {
          ...
          new NotifUtils().success(
            "Supprimer",
            "Formation suprimer avec succès",
            5000
          );
        }
      } catch (error) {
