...
<!--     
    ...
    <select :value="modelValue" 
      @input="
        ...
        }"  :name="name" :id="'in-' + name" class="w-full  px-4 py-3 outline-none rounded-md font-love text-base border-[0.5px] focus:border-blue-500 focus:shadow-md focus:shadow-blue-500/20 focus:border-2">
